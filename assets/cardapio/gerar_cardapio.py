...
CARDAPIO = [
    ("Bolos", [
        ...
        ("Bolo de Chocolate com Amêndoas",
         "Massa de chocolate úmida com farinha de amêndoas, cobertura de brigadeiro.",
    ...
    ("Brownies", [
        ...
        ("Brownie de Doce de Leite",
         "Brownie úmido com um recheio surpresa de doce de leite.",
         "Unidade R$ 10,00  |  Caixa c/ 6 R$ 54,00",
         "assets/images/cardapio/brownie-doce-de-leite-placeholder.jpg"),
        ("Brownie de Castanhas",
         "Textura densa e úmida, com pedaços generosos de castanha-do-pará.",
         "Unidade R$ 10,00  |  Caixa c/ 6 R$ 54,00",
        ...
        ("Brownie Trio de Chocolates",
         "Camadas de chocolate ao leite, meio amargo e branco.",
    ...
    ("Bolachas", [
        ...
        ("Bolacha de Aveia com Frutas Vermelhas",
         "Aveia crocante com pedaços de frutas vermelhas desidratadas.",
         "Pacote c/ 4 R$ 15,00",
    ...
    ("Doces e Brigadeiros", [
        ...
        ("Docinho de Coco Queimado",
         "Clássico docinho brasileiro reinventado, com coco levemente tostado.",
